...
PSYCHOLOGICAL_ISSUES_DATA = {
    PsychologicalIssue.ACADEMIC_ANXIETY: {
        ...
        "common_symptoms": [
            "考试前紧张失眠", "担心成绩不好", "学习压力大", 
            "注意力难以集中", "总觉得时间不够", "害怕老师提问",
            "看到成绩就紧张", "复习时心慌", "觉得自己不够聪明"
        ],
        "student_expressions": [
            "我一想到考试就睡不着觉", "感觉压力好大，喘不过气",
            "总觉得自己学得不够好", "看到别人学习就焦虑",
            "害怕让父母失望", "不敢看考试成绩"
        ]
    },
    ...
    PsychologicalIssue.SOCIAL_PHOBIA: {
        ...
        "common_symptoms": [
            "害怕与人交流", "在人群中感到不适", "担心被人评判",
            "脸红心跳", "声音发抖", "回避社交活动",
            "不敢主动说话", "担心说错话", "觉得别人在议论自己"
        ],
        "student_expressions": [
            "我不敢在课堂上发言", "和陌生人说话就紧张",
            "总觉得别人在看我", "参加聚会很难受",
    ...
    PsychologicalIssue.PROCRASTINATION: {
        ...
        "common_symptoms": [
            "总是拖到最后一刻", "明知道要做却不行动", "为拖延感到内疚",
            "时间管理困难", "容易分心", "逃避重要任务",
            "deadline前焦虑", "自我批评", "完美主义倾向"
        ],
        "student_expressions": [
            "我总是拖作业到最后", "明知道该学习但就是不想动",
            "时间总是不够用", "一想到要做就烦躁",
            "总是被其他事情分心", "每次都说明天开始"
        ]
    },
    ...
    PsychologicalIssue.OCD_SYMPTOMS: {
        ...
        "student_expressions": [
            "我总是要检查好多遍", "门锁了没有要确认很多次",
            "东西必须放得整整齐齐", "总有些想法挥之不去",
            "如果不按顺序做就觉得不对", "洗手要洗很久"
        ]
    },
    ...
    PsychologicalIssue.ADAPTATION_ISSUES: {
        ...
        "common_symptoms": [
            "难以适应新环境", "想念以前的生活", "角色转换困难",
            "社交圈建立困难", "生活习惯改变", "文化差异适应",
            "独立生活压力", "离家焦虑", "新规则学习困难"
        ],
        "student_expressions": [
            "我还是想回家", "这里的生活不习惯",
            "感觉格格不入", "想念高中的朋友",
            "不知道怎么安排大学生活", "一个人生活好困难"
        ]
    },
    ...
    PsychologicalIssue.IDENTITY_CONFUSION: {
        ...
        "common_symptoms": [
            "不知道自己想要什么", "专业选择迷茫", "未来规划困难",
            "自我价值不确定", "能力怀疑", "兴趣不明确",
            "人生方向迷失", "角色认同困惑", "存在意义质疑"
        ],
        "student_expressions": [
            "我不知道自己适合做什么", "对专业没有兴趣",
            "不知道毕业后要干什么", "觉得自己很迷茫",
...
THERAPY_APPROACHES_DATA = {
    TherapyApproach.CBT: {
        ...
        "key_techniques": [
            "认知重构", "行为实验", "问题解决训练", "放松训练",
            "暴露疗法", "认知日记", "家庭作业布置"
        ],
        "communication_style": [
            "结构化询问", "引导式提问", "关注具体事件",
            "挑战不合理想法", "布置实践任务", "关注此时此地"
        ],
        "typical_questions": [
            "你觉得这种想法合理吗？", "有什么证据支持这个想法？",
            "你能想到其他的解释吗？", "如果朋友遇到同样情况，你会怎么建议？"
        ]
    },
    ...
    TherapyApproach.PSYCHOANALYTIC: {
        ...
        "typical_questions": [
            "这让你想到了什么？", "你童年时是否有过类似经历？",
            "你觉得这种反应背后可能有什么原因？", "这种感觉熟悉吗？"
        ]
    },
    ...
    TherapyApproach.SOLUTION_FOCUSED: {
        ...
        "typical_questions": [
            "什么时候这个问题没有发生？", "你是怎么做到的？",
            "如果明天醒来问题解决了，你会注意到什么不同？", "你希望达到什么目标？"
        ]
    },
...
STATE_TRANSITION_GUIDE = {
    CounselorState.INTRODUCTION: {
        ...
        "transition_indicators": [
            "学生开始主动分享", "语气变得放松", "愿意描述具体情况",
            "对咨询师表现出信任", "开始询问咨询相关问题"
        ]
    },
    ...
    CounselorState.EXPLORATION: {
        ...
        "transition_indicators": [
            "核心信息已收集充分", "学生情绪状态稳定", "问题脉络清晰",
            "咨询师已形成初步判断", "学生准备接受专业反馈"
        ]
    },
...
EMOTION_TRANSITIONS = {
    EmotionState.ANXIOUS: [EmotionState.CALM, EmotionState.TRUSTING, EmotionState.HOPEFUL],
    EmotionState.DEPRESSED: [EmotionState.CALM, EmotionState.HOPEFUL, EmotionState.OPEN],
    EmotionState.CONFUSED: [EmotionState.CALM, EmotionState.OPEN, EmotionState.TRUSTING],
    EmotionState.ANGRY: [EmotionState.CALM, EmotionState.OPEN, EmotionState.RESISTANT],
    EmotionState.RESISTANT: [EmotionState.TRUSTING, EmotionState.OPEN, EmotionState.CALM],
    EmotionState.AVOIDANT: [EmotionState.OPEN, EmotionState.TRUSTING, EmotionState.CALM],
...
COMMON_MAJORS = [
    ...
    "机械工程", "土木工程", "建筑学", "电气工程及其自动化",
    "工商管理", "市场营销", "财务管理", "人力资源管理", "会计学",
    "法学", "新闻学", "广告学", "汉语言文学", "英语",
    "心理学", "教育学", "社会工作", "政治学与行政学",
    "数学与应用数学", "物理学", "化学", "生物科学",
    "临床医学", "护理学", "药学", "中医学",
    "美术学", "音乐学", "设计学", "体育教育"
]
...
COMMON_FAMILY_BACKGROUNDS = [
    "单亲家庭", "重组家庭", "普通双职工家庭", "农村家庭", "城市中产家庭",
    "留守儿童背景", "独生子女", "多子女家庭", "隔代抚养", "经济困难家庭"
]

COMMON_PERSONALITY_TRAITS = [
    "内向", "外向", "敏感", "理性", "情绪化", "完美主义", "乐观", "悲观",
    "独立", "依赖", "社交恐惧", "人来疯", "责任心强", "拖延", "焦虑型",
    "回避型", "安全型", "冲动", "谨慎", "创新", "保守", "竞争性强"
]
